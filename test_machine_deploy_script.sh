...
# 6] customer is complaining, there are no files in /cdrom directory and he deleted nothing
...
#       9.1] do sha512 of same iso, and explain what is diffrence, why, and what this commands are for
# 10] can you imagine how to generate (pseudo)random 10 characters long sting [that could be e.g. used as passowrd]
# 11] Every day at 18:15 and 6:15 run following: check how much space is consumed on all disks and save the output to /tmp/diskfree-<date-timestamp>.log
